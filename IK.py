...
#Facebook : Imtiaz Baloch
#Whatsapp : ++9230**
#Pakistan Cyber Expert IKB
#Alone Coder 
...
\x1b[1;94mâž£ 
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94mâž£  YouTube  : IKB KINGS
\x1b[1;94mâž£  Facebook : IMTIAZ BALOCH
\x1b[1;94mâž£  Note     : COMMANDS MAKER IKB
\x1b[1;94mâž£  Github   : https://github.com/ImtiazIk
\x1b[1;94mâž£  Whatsapp : 03089550745
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:IKB
	    time.sleep(1)
            loop = 'false'
        else:
            print "\033[1;97mACCESS DENIED"
            os.system('xdg-open https://m.youtube.com/channel/UCVNQpCWRdKMyPJPsQT9J0cg')
    else:
        print "\033[1;97mACCESS DENIED"
        os.system('xdg-open https://m.youtube.com/channel/UCVNQpCWRdKMyPJPsQT9J0cg')
def login():
	...
	try:
		...
		jalan(' \033[1;97m   âœ§ \033[1;97mðŸ‘‰ : \033[1;97mIKB ' ) 
